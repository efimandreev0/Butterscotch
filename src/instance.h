...
typedef struct Instance {
    ...
    // Scratch: index of this instance in runner->instances[]. Maintained by
    // Runner_ensureBBoxCache each frame so collision candidates found through
    // cached object-index maps can quickly look up their bboxCache entry.
